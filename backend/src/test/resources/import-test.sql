...
INSERT INTO MoteurCatalogueEntity (id, modele, marque, type, description, puissanceCv, puissanceKw, arbre, cylindres, cylindree, evaluation, stock, stockAlerte, prixPublic, frais, tauxMarge, tauxMarque, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (100, 'Mercury 115 EFI', 'Mercury', 'Hors-bord', 'Moteur 4 temps', 115, 85, 0, 4, 2100, 0, 5, 1, 12000.0, 0, 0, 0, 10000.0, 20.0, 2000.0, 12000.0);
