...
-- Catalogue bateaux
INSERT INTO BateauCatalogueEntity (id, designation, type, description, evaluation, anneeDebut, anneeFin, longueurExterieure, largeur, poidsVide, stock, stockAlerte, prixVenteHT, tva, montantTVA, prixVenteTTC, longueurCoque, hauteur, tirantAir, tirantEau, poidsMoteurMax, chargeMax, reservoirEau, reservoirCarburant, nombrePassagersMax) VALUES (100, 'Quicksilver 505', 'Open', 'Bateau open polyvalent', 4.0, 2024, 2024, 5.05, 2.10, 650, 3, 1, 22000.0, 20.0, 4400.0, 26400.0, 4.80, 1.50, 2.0, 0.5, 200.0, 800.0, 50.0, 100.0, 6);

-- Catalogue moteurs (all primitive fields included)
INSERT INTO MoteurCatalogueEntity (id, designation, type, description, anneeDebut, anneeFin, puissanceCv, puissanceKw, arbre, cylindres, cylindree, evaluation, stock, stockAlerte, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (100, 'Mercury 115 EFI', 'Hors-bord', 'Moteur 4 temps', NULL, NULL, 115, 85, 0, 4, 2100, 0, 5, 1, 10000.0, 20.0, 2000.0, 12000.0);

-- Catalogue helices (all primitive fields included)
INSERT INTO HeliceCatalogueEntity (id, designation, description, diametre, pales, cannelures, evaluation, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (100, 'Mercury Vengeance 14x19', 'Helice inox', 14, 3, 15, 0, 300.0, 20.0, 60.0, 360.0);

-- Catalogue remorques (all primitive fields included)
INSERT INTO RemorqueCatalogueEntity (id, designation, description, evaluation, ptac, chargeAVide, chargeUtile, longueur, largeur, longueurMaxBateau, largeurMaxBateau, stock, stockAlerte, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (100, 'Sun Way 500', 'Remorque routiere', 0, 750, 200, 550, 600, 200, 500, 200, 2, 1, 2000.0, 20.0, 400.0, 2400.0);

-- Catalogue produits (all primitive fields included)
INSERT INTO ProduitCatalogueEntity (id, designation, categorie, description, evaluation, stock, stockMini, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (100, 'Motul Huile moteur 4T', 'Entretien', 'Huile marine 4 temps', 0, 50, 10, 20.0, 20.0, 4.0, 24.0);
INSERT INTO ProduitCatalogueEntity (id, designation, categorie, description, evaluation, stock, stockMini, prixVenteHT, tva, montantTVA, prixVenteTTC) VALUES (101, 'Mercury Filtre a huile', 'Entretien', 'Filtre compatible Mercury', 0, 2, 5, 12.0, 20.0, 2.4, 14.4);
...
ALTER TABLE BateauOptionEntity ALTER COLUMN id RESTART WITH 200;
